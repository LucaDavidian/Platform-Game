...
bool GUIButton::OnMouseMove(int x, int y, int, int) 
{
	if (IsInside(x, y))
	{
...
bool GUIButton::OnMousePress(int x, int y) 
{
	if (IsInside(x, y))
	{
		mIsSelected = true;
...
bool GUIButton::OnMouseRelease(int x, int y) 
{
	if (mIsSelected)
	{
		mIsSelected = false;
